...
exports.fetcher = function (options, _a, fetch) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            return [2 /*return*/, fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname }))];
        });
    });
};
function extendHook(customFetcher, swrOptions) {
    var useOrders = function () {
        ...
        return use_data_1.default(defaultOpts, [
