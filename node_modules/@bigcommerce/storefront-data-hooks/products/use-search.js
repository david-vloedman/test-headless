...
exports.fetcher = function (options, _a, fetch) {
    var _b;
    var search = _a.search, categoryId = _a.categoryId, stringifiedCategoryIds = _a.stringifiedCategoryIds, brandId = _a.brandId, sort = _a.sort, page = _a.page;
    ...
    return fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname + url.search }));
};
