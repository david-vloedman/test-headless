...
var use_signup_1 = __importDefault(require("./commerce/use-signup"));
...
exports.fetcher = function (options, _a, fetch) {
    var _b;
    var firstName = _a.firstName, lastName = _a.lastName, email = _a.email, password = _a.password, rest = __rest(_a, ["firstName", "lastName", "email", "password"]);
    ...
    return fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname, body: __assign({ firstName: firstName, lastName: lastName, email: email, password: password }, rest) }));
};
function extendHook(customFetcher) {
    var useSignup = function () {
        var revalidate = use_customer_1.default().revalidate;
        var fn = use_signup_1.default(defaultOpts, customFetcher);
        return react_1.useCallback(function signup(input) {
