...
var use_remove_item_1 = __importDefault(require(".././commerce/wishlist/use-remove-item"));
var use_customer_1 = __importDefault(require("../use-customer"));
var use_wishlist_1 = __importDefault(require("./use-wishlist"));
var defaultOpts = {
...
exports.fetcher = function (options, _a, fetch) {
    ...
    return fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname, body: { itemId: itemId } }));
};
function extendHook(customFetcher) {
    var useRemoveItem = function (opts) {
        var customer = use_customer_1.default().data;
        var revalidate = use_wishlist_1.default(opts).revalidate;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fn({ itemId: String(input.id) })];
                        case 1:
                            data = _a.sent();
