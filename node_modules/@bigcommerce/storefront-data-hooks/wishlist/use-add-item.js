...
var use_add_item_1 = __importDefault(require(".././commerce/wishlist/use-add-item"));
...
exports.fetcher = function (options, _a, fetch) {
    ...
    return fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname + url.search, body: { item: item } }));
};
function extendHook(customFetcher) {
    var useAddItem = function (opts) {
