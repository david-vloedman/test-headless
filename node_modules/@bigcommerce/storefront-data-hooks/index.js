...
exports.bigcommerceConfig = {
    ...
    fetcher: function (_a) {
        var url = _a.url, _b = _a.method, method = _b === void 0 ? 'GET' : _b, variables = _a.variables, bodyObj = _a.body, credentials = _a.credentials;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(url, { method: method, body: body, headers: headers, credentials: credentials })];
                    case 1:
                        res = _c.sent();
