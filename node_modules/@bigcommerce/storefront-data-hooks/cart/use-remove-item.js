...
exports.fetcher = function (options, _a, fetch) {
    var _b;
    var itemId = _a.itemId, include = _a.include;
    ...
    return fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname + url.search, body: { itemId: itemId } }));
};
function extendHook(customFetcher) {
    var useRemoveItem = function (item, input) {
        ...
        return react_1.useCallback(function removeItem(_a) {
            var _b;
            var itemId = _a.id;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, fn({
                                itemId: itemId !== null && itemId !== void 0 ? itemId : item === null || item === void 0 ? void 0 : item.id,
                                include: (_b = input === null || input === void 0 ? void 0 : input.include) === null || _b === void 0 ? void 0 : _b.join(','),
                            })];
                        case 1:
                            data = _c.sent();
