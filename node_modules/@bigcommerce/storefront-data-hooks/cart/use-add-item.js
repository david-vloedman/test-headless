...
exports.fetcher = function (options, _a, fetch) {
    var _b;
    var item = _a.item, locale = _a.locale, include = _a.include;
    if (item.quantity &&
    ...
    return fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname + url.search, body: { item: item, locale: locale } }));
};
function extendHook(customFetcher) {
    var useAddItem = function (input) {
        var mutate = use_cart_1.default(input).mutate;
        var locale = __1.useCommerce().locale;
        var fn = use_add_item_1.default(defaultOpts, customFetcher);
        return react_1.useCallback(function addItem(item) {
            var _a;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, fn({
                                item: item,
                                locale: locale,
                                include: (_a = input === null || input === void 0 ? void 0 : input.include) === null || _a === void 0 ? void 0 : _a.join(','),
                            })];
                        case 1:
                            data = _b.sent();
