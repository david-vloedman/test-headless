...
var use_login_1 = __importDefault(require("./commerce/use-login"));
...
exports.fetcher = function (options, _a, fetch) {
    ...
    return fetch(__assign(__assign(__assign({}, defaultOpts), options), { url: ((options === null || options === void 0 ? void 0 : options.base) || '') + url.pathname, body: { email: email, password: password } }));
};
function extendHook(customFetcher) {
    function useLogin(params) {
        ...
        var fn = use_login_1.default(options, customFetcher);
        return react_1.useCallback(function login(input) {
