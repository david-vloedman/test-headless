...
var signup = function (_a) {
    var req = _a.req, res = _a.res, _b = _a.body, firstName = _b.firstName, lastName = _b.lastName, email = _b.email, password = _b.password, phone = _b.phone, company = _b.company, acceptsEmails = _b.acceptsEmails, notes = _b.notes, addresses = _b.addresses, config = _a.config;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                return [4 /*yield*/, login_1.default({ variables: { email: email, password: password }, req: req, res: res, config: config })];
                case 5:
                    // Login the customer right after creating it
                    _d.sent();
