...
var BigcommerceGraphQLError = /** @class */ (function (_super) {
    ...
    function BigcommerceGraphQLError(msg) {
        var _this = _super.call(this, msg) || this;
        // Necessary to compile to ES5: https://github.com/microsoft/TypeScript/issues/22585
        Object.setPrototypeOf(_this, BigcommerceGraphQLError.prototype);
        return _this;
    }
...
var BigcommerceApiError = /** @class */ (function (_super) {
    ...
    function BigcommerceApiError(msg, res, data) {
        var _this = _super.call(this, msg) || this;
        // Necessary to compile to ES5: https://github.com/microsoft/TypeScript/issues/22585
        Object.setPrototypeOf(_this, BigcommerceApiError.prototype);
...
var BigcommerceNetworkError = /** @class */ (function (_super) {
    ...
    function BigcommerceNetworkError(msg) {
        var _this = _super.call(this, msg) || this;
        // Necessary to compile to ES5: https://github.com/microsoft/TypeScript/issues/22585
        Object.setPrototypeOf(_this, BigcommerceNetworkError.prototype);
