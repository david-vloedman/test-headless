...
var getProducts = function (_a) {
    var res = _a.res, _b = _a.body, search = _b.search, category = _b.category, categories = _b.categories, brand = _b.brand, sort = _b.sort, page = _b.page, config = _a.config;
    return __awaiter(void 0, void 0, void 0, function () {
        var url, categoriesIn, _c, _sort, direction, sortValue, _d, data, meta, entityIds, found, graphqlData, productsById, products, pagination;
        var _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    _d = _g.sent(), data = _d.data, meta = _d.meta;
                ...
                case 2:
                    ...
                    pagination = __assign(__assign({}, lodash_omit_1.default(meta.pagination, ['links', 'current_page'])), { pages: __assign(__assign({ current: meta.pagination.current_page }, ((_e = meta.pagination.links) === null || _e === void 0 ? void 0 : _e.previous) ? {
                            previous: meta.pagination.current_page - 1
                        } : {}), ((_f = meta.pagination.links) === null || _f === void 0 ? void 0 : _f.next) ? {
                            next: meta.pagination.current_page + 1
                        } : {}) });
                    res.status(200).json({ data: { products: products, found: found, pagination: pagination } });
                    return [2 /*return*/];
            }
        });
    });
