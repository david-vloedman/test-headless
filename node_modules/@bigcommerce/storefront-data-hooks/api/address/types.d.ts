...
export declare type AddressType = "residential" | "commercial";
export declare type FormFieldValue = CustomerFormFieldValue | CustomerAddressFormFieldValue;
...
export declare type AddressesResponse = {
    addresses: Address[];
...
export declare type GetAddressesBody = {
    customerToken?: string;
    page?: string;
};
export declare type AddAddressBody = AddressBody;
export declare type UpdateAddressBody = AddressBody & {
    id: number;
};
export declare type RemoveAddressBody = {
    id: number;
};
export declare type AddressHandlers = {
